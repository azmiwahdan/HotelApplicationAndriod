...
public class LoginService {
    ...
    public static Customer getCustomerByUsername(String username,String password,List<Customer>customerList){
        Customer customer=new Customer(username,password);
        for (int i=0;i<customerList.size();i++)
            if (customerList.get(i).equals(customer)) customerList.get(i);
        return null;
    }
